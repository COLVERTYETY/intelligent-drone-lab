...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        rospy.Subscriber('/joy_unified', Joy, drone.read_joystick)
        rospy.spin()

        # msg = rospy.wait_for_message('/cf2/filtredsignal', Float64MultiArray)
        # drone.read_velocity(msg)
        # #print(drone.velocity[drone.ids[0]-1])
        # rospy.sleep(0.1)
        # drone.on_press(drone.joystick)
