...
class GestureDrone:
    ...
    def cf3_callback(self, msg):
        ...
        while abs(self.cf3.position()[0])>1.0 or abs(self.cf3.position()[1])>1.0 or abs(self.cf3.position()[0])>1.0:
            print ("go home now")
        ...
        if self.followMode == False :
            ...
            if msg.data == 'THUMBDOWN':#start_up
                #print(".")
                self.cf3.land(0.05, duration=1.0)


            if msg.data == 'UP':#start_up
                #print(".")
                self.cf3.cmdVelocityWorld(np.array([0, 0, self.velocity]), yawRate=0)
                #rospy.sleep()
            ...
            if msg.data == 'RIGHT': #start_right
                #print(".")
                self.cf3.cmdVelocityWorld(np.array([-self.velocity, 0, 0]), yawRate=0)
                #rospy.sleep()
        ...
        if self.followMode == True :
            ...
            if msg.data == 'RIGHT SLIDE' :#start_right
                self.cf3.cmdVelocityWorld(np.array([-self.velocity2, 0, 0]), yawRate=0)
            ...
            if msg.data == 'UP SLIDE': #start_up
                ...
                self.cf3.cmdVelocityWorld(np.array([0, 0, self.velocity2]), yawRate=0)
    ...
    def cf2_callback(self, msg):
        ...
        while abs(self.cf2.position()[0])>1.0 or abs(self.cf2.position()[1])>1.0 or abs(self.cf2.position()[0])>1.0:
            print ("go home now")
        ...
        if self.followMode == False :
            ...
            if msg.data == 'THUMBDOWN':#start_up
                #print(".")
                self.cf2.land(0.05, duration=1.0)


            if msg.data == 'UP':#start_up
                #print(".")
                self.cf2.cmdVelocityWorld(np.array([0, 0, self.velocity]), yawRate=0)
                #rospy.sleep()
            ...
            if msg.data == 'RIGHT': #start_right
                #print(".")
                self.cf2.cmdVelocityWorld(np.array([0, -self.velocity, 0]), yawRate=0)
                #rospy.sleep()
        ...
        if self.followMode == True :
            ...
            if msg.data == 'RIGHT SLIDE' :#start_right
                self.cf2.cmdVelocityWorld(np.array([0, self.velocity2, 0]), yawRate=0)
                print("slide right, follow.")
                #pos = self.cf.position() + np.array([0, -0.05, 0])
                #self.cf.goTo(pos, yawRate=0)
                #self.cf.goTo(np.array([0, self.velocity, 0]), yawRate=0)
            ...
            if msg.data == 'UP SLIDE': #start_up
                print("slide up")
                #pos = self.cf.position() + np.array([0, 0, self.velocity])               
                self.cf2.cmdVelocityWorld(np.array([0, 0, self.velocity2]), yawRate=0)
    ...
    def listener(self):
        ...
        handsignal_subscriber = rospy.Subscriber('/hand/signal', String, self.cf3_callback)
        handsignal_subscriber = rospy.Subscriber('/hand/signal2', String, self.cf2_callback)
...
if __name__ == '__main__':
    ...
    #     listener.join()
    drone = GestureDrone(allcfs.crazyflies[0], allcfs.crazyflies[1])
